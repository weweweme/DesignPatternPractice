...
namespace  Util
{
    public class PlayerAnimationStringLiteral
    {
        ...
        public static readonly string IsRunDiveRoll = "isRunDiveRoll";
    }
    ...
    public class PlayerAnimationHashLiteral
    {
        ...
        public static readonly int IsRunDiveRoll = Animator.StringToHash(PlayerAnimationStringLiteral.IsRunDiveRoll);
    }
}
